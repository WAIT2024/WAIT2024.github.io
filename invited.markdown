...
<div style="display: flex; align-items: center;">
  <img src="[image/andrei_voronkov.jpg](https://github.com/WAIT2024/WAIT2024.github.io/blob/main/image/andrei_voronkov.jpg)" height="300" style="margin-right: 20px;"> <!-- Adjust margin as needed -->
